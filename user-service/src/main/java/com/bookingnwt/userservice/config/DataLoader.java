...
public class DataLoader {
    ...
    CommandLineRunner initUserData(UserRepository userRepo,
        ...
        return args -> {
            // --- Kreiranje korisnika ---
            User admin = new User("admin@bookingnwt.com", "hashed_admin_pass",
                    "Admin", "Sistema", "+38761000001", UserRole.ADMIN);
            userRepo.save(admin);

            User host1 = new User("emir.d@email.com", "hashed_pass_1",
                    "Emir", "Duvnjak", "+38761100001", UserRole.HOST);
            userRepo.save(host1);

            User host2 = new User("ahmed.c@email.com", "hashed_pass_2",
                    "Ahmed", "Čorhusić", "+38761100002", UserRole.HOST);
            userRepo.save(host2);

            User guest1 = new User("benjamin.h@email.com", "hashed_pass_3",
                    "Benjamin", "Hadžihasanović", "+38762200001", UserRole.GUEST);
            userRepo.save(guest1);

            User guest2 = new User("kenan.a@email.com", "hashed_pass_4",
                    "Kenan", "Abadžić", "+38762200002", UserRole.GUEST);
            userRepo.save(guest2);

            User guest3 = new User("marija.m@email.com", "hashed_pass_5",
